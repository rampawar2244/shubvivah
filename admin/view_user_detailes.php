      ...
      <div class="text-center">
    	...
    	<div class="col-sm-9">
            <ul class="nav nav-tabs">
                ...
                <!-- <li><a data-toggle="tab" href="#search">Search Your Partner</a></li> -->
              </ul>
<!-- HOME DATA FETCH -->
<?php
  $sql = "SELECT * FROM user WHERE user_id= $user_id && user_data_type='register' ";
  $sql_run = mysqli_query($con,$sql);
...
?>
      ...
      $sql = "SELECT * FROM user WHERE user_id= $user_id && user_data_type='education_profession' ";
      $sql_run = mysqli_query($con,$sql);
      if (mysqli_num_rows($sql_run) > 0) {
...
<?php
                ...
                $sql = "SELECT * FROM user WHERE user_id=$user_id && user_data_type='upload' ";
                $sql_run = mysqli_query($con,$sql);
                if (mysqli_num_rows($sql_run) > 0) {
